...
const Button = ({ children, ...props }) => {
  return (
    <button
      {...props}
      // onClick={onClick}
      className="btn relative inline-flex items-center justify-start overflow-hidden font-thin tracking-widest transition-all bg-dark rounded-sm hover:bg-dullText group py-2 px-5 shadow-md"
    >
