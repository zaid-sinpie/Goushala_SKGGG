...
const Button = ({ children, ...props }) => {
  return (
    <button
      {...props}
      className="btn relative inline-flex items-center justify-start overflow-hidden font-thin tracking-widest transition-all bg-dark rounded-sm hover:bg-dullText group py-1 px-5 text-[12px] shadow-md"
    >
