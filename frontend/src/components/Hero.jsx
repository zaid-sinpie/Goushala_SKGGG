...
const Hero = () => {
  return (
    <div className="h-screen max-xl:h-auto w-full bg-img1 bg-center bg-fixed bg-cover flex items-end justify-start max-xl:justify-center max-sm:items-center py-5 max-xl:py-20 max-sm:py-20 px-10 max-sm:p-0 overflow-hidden">
      <article className="w-[50%] h-fit max-sm:h-auto py-20 max-2xl:py-10 max-xl:py-10 max-sm:py-5 px-10 rounded-lg max-sm:w-[90%] max-xl:w-[90%] flex flex-col justify-center items-start text-center gap-[5rem] max-lg:gap-[3rem] max-2xl:gap-[3rem] max-sm:gap-5 text-4xl max-sm:text-xl bg-blur backdrop-blur-md shadow-xl">
